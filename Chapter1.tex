	...
	\section{Fiber Bundles}
		...
		\subsection{Formal Definition}
			...
			\begin{definition}[Fiber Bundle]\label{Def:SmoothBundle}
				...
				$\forall x \in M \; \exists$ a couple $(U, \chi)$ (called \emph{local trivialization})
					\begin{itemize}
...
%			\end{notationfix}
			...
			\begin{definition}[Bundle atlas]
				We call a \emph{Bundle Atlas} a collection of local charts which trivializes $E$. I.e. triples  $(U_\alpha, \psi_\alpha, \chi_\alpha)$ where:
				\begin{itemize}
