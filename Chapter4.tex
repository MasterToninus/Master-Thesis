...
\fi
	...
	\subsection{Geometric picture of Peierls brackets}
		...
		In first instance, Peierl's procedure consider a not necessarily linear Lagrangian density $\chi\in \Lag(E)$. The unique constraint is posed on the support condition of $\chi$.\\
