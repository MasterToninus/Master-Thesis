...
\fi	
			...
			\vspace{2mm}
		Anyway all this machinery it is not necessary in the case that the coefficient $\ddot{a}/a$ is a positive constant, \textit{i.e.} in  the \emph{De Sitter} spacetimes where $ a(t) = exp(H t)$.  \cite{Wald1984}
