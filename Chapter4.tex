...
\begin{Warning}
	\textbf{Da MODIFICARE}\\
			These operators are the Hilbert–Schmidt integral operators:
			\begin{displaymath}
...
\begin{Warning}
		...
		\ifToninus Anyway all this machinery it is not necessary \fi In the special case of \emph{De Sitter} spacetime, where $ a(t) = exp(H t)$ and the coefficient $\ddot{a}/a$ is a positive constant  \cite{Wald1984}, the general solutions are:% simply:
		\begin{displaymath}
