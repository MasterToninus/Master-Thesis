...
\newpage
	...
	\subsection{Solution of the disturbed motion}
		...
		\end{displaymath}
		\begin{equation}\label{PeierlJacobiEq}
	...
	\subsection{Extension to non-linear theories}
		In the precedent costruction the green-hyperbolicity of motion operator $P$ plays a primary role.
		...
		%Anyway the problem of searching perturbed solution of the disturbed dynamic can be stated even in presence  of non-linear field theories.
		\begin{figure}[h!]
				  \centering
   	\includegraphics[width=0.5\textwidth]{Pictures/Linearization} 
		...
		In the precedent case was natural restrict the choice of the possible variation to the linear one only but this preferential choice is no longer possible.
