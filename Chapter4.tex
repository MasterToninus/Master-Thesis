...
\subsection{Example: Geodesic field on FRW space-time.}
	...
	We recall that the Friedmann–Lemaître–Robertson–Walker spacetime is a 4D homogeneous isotropic manifold that solves exactly the Einstein equations.
	
	 ... \danger
	
	\begin{equation}
		ds^2 = dt^2 - a(t) \left( \frac{dr^2}{1-k r^2} + r^2 d\theta^2 + sin^2(\theta) d\phi^2\right)
	\end{equation}
		...
		\begin{displaymath}
			\gamma(t)^\mu = ( u(t),0,0,0)
		\end{displaymath}
		This is a geodesic if:
