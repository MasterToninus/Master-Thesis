...
\begin{abstract}
	...
	\vspace{2mm}
	La soluzione ideale sarebbe quella di creare un riquadro condizionale (tipo ifndef di c++) con una flag iniziale, osservazioni e mezze intuizioni potrebbero essere messe in modo poppabile	
