...
\section*{Fiber Bundles}
	\begin{minipage}{0.5\textwidth}
			\includegraphics[width=\textwidth]{../Pictures/fiberbundle}
		\end{minipage}
		\begin{minipage}{0.5\textwidth}
\begin{definition}[Fiber Bundle]\label{Def:SmoothBundle}
	...
	\begin{definition}[Local Trivialization of the Fiber Bundle $E$]				
		...
		\end{minipage}
			\begin{minipage}{0.5\textwidth}
   						\includegraphics[width=0.8\textwidth]{../Pictures/Tautological1Form}
 						\footnote{The definition of tautological 1-form is achieved exploiting the concept of \emph{Tangent map} and remembering that $\alpha_p: T_p \Phase \rightarrow \Phase$ is a linear functional.}
		\end{minipage}
		...
		\begin{remark}\label{MultiIndex}
			...
			finite dimensional vector  $I=(i_1, i_2, \ldots, i_m)\: \in \Natural^m_0$ with $m<\infty$, \emph{i.e.} a t-ple composed of non negative natural numbers including $0$.
			\\
