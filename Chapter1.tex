...
%		\end{thesis}
	...
	\subsection{Green Operators and O.D.E.}
	...
	We can see them as a trivial case of l.p.d.o. on $\Gamma(E) = C^\infty(\Real)$.
	...
	of $n$-th order.
	\begin{Warning}
		Vedi Gaeta, c'è una condizione ulteriore di regolarità sui coefficienti
	\end{Warning}
	In this context is more common to refer to Green \textit{functions} instead of Green \textit{operators}.
