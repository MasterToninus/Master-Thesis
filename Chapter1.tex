...
%				\\
%				In case of vector bundles it is also a linear Frechet space\cite{Kriegl}.
%				, and the sections are called "vector fields". (CD, non sono sicuro, di solito questo nome in geometria differenziali è riservato per i campi intesi come sezione del fibrato tangente
%			\end{observation}
