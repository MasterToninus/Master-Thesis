...
In paragraph 2 we will enrich this abstract object with a so called \emph{G-Structure}, a superstructure that must be necessarily identified if you want to have available a concept of compatibility between overlapping trivializations.
