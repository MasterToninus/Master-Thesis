 ...
 \fi
   		...
   		\paragraph{Algebraic State and Hilbert state representation} 
			...
			\subparagraph{GNS reconstruction}
				...
				These object are important inasmuch the %The importance of these objects is that the 
...
%				\end{notationfix}
				...
				\begin{proposition}
					Let $\ObsAlg$ be any topological unital $\ast-$algebra and $\pi$ a faithful strongly continuous %( \textit{i.e.} in the operator norm topology) no! è la convergenza in norma della successione delle immagini $A_n (y)$ con $ y \in D$
